...
<?= $this->section('content') ?>  
            ...
            <div class="mx-auto p-4">
                ...
                <div class="flex">
                    ...
                    <button data-modal-target="export-data" data-modal-toggle="export-data" class="flex text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-green-600 hover:bg-green-700 mr-5" type="button">
