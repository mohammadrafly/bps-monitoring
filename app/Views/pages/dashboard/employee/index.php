...
<?= $this->section('content') ?>  
            ...
            <div class="mx-auto p-4">
                ...
                <div class="flex">
                    <button data-modal-target="default-modal" data-modal-toggle="default-modal" class="flex text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 mr-5" type="button">
                    ...
                    <button data-modal-target="export-data" data-modal-toggle="export-data" class="flex text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 mr-5" type="button">
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow ">
                            ...
                            <div class="p-4 md:p-5 space-y-4">
                                <form id="form" class="p-4 md:p-5" action="<?= base_url('dashboard/employee/export') ?>" method="post">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2 flex">
                                        <button onclick="updateData(<?= $row['id'] ?>)" class="flex dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-medium text-sm rounded-lg py-2 px-4 mr-2">
                                        ...
                                        <button onclick="deleteData(<?= $row['id'] ?>)" class="flex dark:bg-red-600 dark:hover:bg-red-700 text-white font-medium text-sm rounded-lg py-2 px-4">
