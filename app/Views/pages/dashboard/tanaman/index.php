                                ...
                                <form id="form" class="p-4 md:p-5">
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        <div class="col-span-2">
                                            <label for="input" class="block mb-2 text-sm font-medium text-gray-500">Nama Tanaman</label>
                                            <input type="text" id="nama_tanaman" name="nama_tanaman" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-200 dark:border-gray-200 dark:placeholder-gray-400 dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Masukan Nama Tanaman" required="">
...
<script src="<?= base_url('assets/js/Tanaman.js') ?>"></script>
