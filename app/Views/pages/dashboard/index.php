        ...
        <div class="w-full rounded-lg shadow bg-white p-4 mt-5">
            <div class="flex justify-between pb-4 mb-4 border-b border-gray-200">
                <div class="flex items-center">
                    ...
                    <div>
                        <h5 class="leading-none text-2xl font-bold text-gray-900  pb-1"><?= $getTotalThisWeek ?></h5>
                        <p class="text-sm font-normal text-gray-500 ">Total Progres Perminggu</p>
                    </div>
                </div>
                <div>
                    <span class="<?= ($persen > 0) ? 'bg-green-100 text-green-500' : (($persen < 0) ? 'bg-red-100 text-red-500' : 'bg-gray-100 text-gray-500 dark:text-gray-500') ?> text-xs font-medium inline-flex items-center px-2.5 py-1 rounded-md">
