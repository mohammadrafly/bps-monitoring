<nav class="bg-white text-gray-600 w-64 min-h-screen p-4">
    <div class="space-y-4 font-medium">
        ...
        <a href="<?= base_url('dashboard/tanaman') ?>" class="flex py-2 px-4 rounded-lg hover:bg-bps-green-fade hover:text-white <?= current_url() == base_url('dashboard/users') ? 'bg-bps-orange text-white' : '' ?>">
